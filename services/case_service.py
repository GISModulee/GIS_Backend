...
# ===================================================
# `created_by` is passed in explicitly by the router (derived from
# current_user['user_id']) rather than read off the schema — see
# schemas/case_schema.py for why CaseCreate no longer carries this field.
