...
def login_user(user):
    ...
    try:
        with engine.begin() as conn:
            ...
            # --- Audit: bad password ---
            # Deliberately the SAME message as above, so the response
            # body can't be used to enumerate registered emails. The
            # logs distinguish the two cases; the client never sees it.
            ...
            # --- Success: update last_login in the same transaction ---
