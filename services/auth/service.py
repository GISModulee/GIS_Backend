...
def register_user(user, db):
    ...
    try:
        ...
        if existing is not None:
            ...
            raise ConflictError(AUTH_EMAIL_ALREADY_REGISTERED)
        ...
        raise ServiceUnavailableError(AUTH_REGISTRATION_FAILED) from e
...
def login_user(user, db):
    ...
    try:
        ...
        if db_user is None:
            ...
            raise UnauthorizedError(AUTH_INVALID_EMAIL_OR_PASSWORD)
        ...
        raise ServiceUnavailableError(AUTH_LOGIN_FAILED) from e
