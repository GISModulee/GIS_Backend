...
export default function SymmetricDifferenceAction({ onCancel }) {
  ...
  const handleRun = async () => {
    ...
    setLoading(true);
    const toastId = toast.loading("Computing symmetric difference...");
    try {
      ...
      toast.success(response?.message || "✓ Symmetric difference layer created and added to map!", { id: toastId });
    ...
    <div className="space-y-2 pt-1 border-t border-gray-100 dark:border-gray-800">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Symmetric Difference result"
          disabled={loading}
